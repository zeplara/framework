...
zend_class_entry *zeplara_support_file_finder_abstractfilter_ce;
zend_class_entry *zeplara_http_abstractmessage_ce;
zend_class_entry *zeplara_routing_attribute_ce;
zend_class_entry *zeplara_support_repository_ce;
zend_class_entry *zeplara_container_containerexception_ce;
zend_class_entry *zeplara_http_request_ce;
zend_class_entry *zeplara_support_file_parser_abstractparser_ce;
...
zend_class_entry *zeplara_support_facades_facade_ce;
zend_class_entry *zeplara_support_file_finder_callbackfilter_ce;
zend_class_entry *zeplara_support_file_finder_datefilter_ce;
zend_class_entry *zeplara_support_file_finder_directoryfilter_ce;
zend_class_entry *zeplara_support_file_finder_executablefilter_ce;
zend_class_entry *zeplara_support_file_finder_fileextensionfilter_ce;
zend_class_entry *zeplara_support_file_finder_filefilter_ce;
zend_class_entry *zeplara_support_file_finder_filefinder_ce;
zend_class_entry *zeplara_support_file_finder_filterfactory_ce;
zend_class_entry *zeplara_support_file_finder_ignoredotfilefilter_ce;
zend_class_entry *zeplara_support_file_finder_iterator_ce;
zend_class_entry *zeplara_support_file_finder_linkfilter_ce;
zend_class_entry *zeplara_support_file_finder_readablefilter_ce;
zend_class_entry *zeplara_support_file_finder_writablefilter_ce;
zend_class_entry *zeplara_support_file_parser_compiledvalue_ce;
zend_class_entry *zeplara_support_file_parser_envparser_ce;
zend_class_entry *zeplara_support_file_parser_linesiterator_ce;
zend_class_entry *zeplara_support_file_parser_parserexception_ce;
zend_class_entry *zeplara_support_file_parser_rawvalue_ce;
zend_class_entry *zeplara_support_file_splfileinfo_ce;
...
static PHP_MINIT_FUNCTION(zeplara)
{
	...
	ZEPHIR_INIT(Zeplara_Support_File_Finder_AbstractFilter);
	ZEPHIR_INIT(Zeplara_Http_AbstractMessage);
	ZEPHIR_INIT(Zeplara_Routing_Attribute);
	ZEPHIR_INIT(Zeplara_Support_Repository);
	ZEPHIR_INIT(Zeplara_Container_ContainerException);
	ZEPHIR_INIT(Zeplara_Http_Request);
	ZEPHIR_INIT(Zeplara_Support_File_Parser_AbstractParser);
	...
	ZEPHIR_INIT(Zeplara_Support_Facades_Facade);
	ZEPHIR_INIT(Zeplara_Support_File_Finder_CallbackFilter);
	ZEPHIR_INIT(Zeplara_Support_File_Finder_DateFilter);
	ZEPHIR_INIT(Zeplara_Support_File_Finder_DirectoryFilter);
	ZEPHIR_INIT(Zeplara_Support_File_Finder_ExecutableFilter);
	ZEPHIR_INIT(Zeplara_Support_File_Finder_FileExtensionFilter);
	ZEPHIR_INIT(Zeplara_Support_File_Finder_FileFilter);
	ZEPHIR_INIT(Zeplara_Support_File_Finder_FileFinder);
	ZEPHIR_INIT(Zeplara_Support_File_Finder_FilterFactory);
	ZEPHIR_INIT(Zeplara_Support_File_Finder_IgnoreDotFileFilter);
	ZEPHIR_INIT(Zeplara_Support_File_Finder_Iterator);
	ZEPHIR_INIT(Zeplara_Support_File_Finder_LinkFilter);
	ZEPHIR_INIT(Zeplara_Support_File_Finder_ReadableFilter);
	ZEPHIR_INIT(Zeplara_Support_File_Finder_WritableFilter);
	ZEPHIR_INIT(Zeplara_Support_File_Parser_CompiledValue);
	ZEPHIR_INIT(Zeplara_Support_File_Parser_EnvParser);
	ZEPHIR_INIT(Zeplara_Support_File_Parser_LinesIterator);
	ZEPHIR_INIT(Zeplara_Support_File_Parser_ParserException);
	ZEPHIR_INIT(Zeplara_Support_File_Parser_RawValue);
	ZEPHIR_INIT(Zeplara_Support_File_SplFileInfo);
...
static PHP_RINIT_FUNCTION(zeplara)
{
	...
	zephir_initialize_memory(zeplara_globals_ptr);
		...
		zephir_init_static_properties_Zeplara_Routing_Attribute(TSRMLS_C);
		...
		zephir_init_static_properties_Zeplara_Support_File_Parser_EnvParser(TSRMLS_C);
