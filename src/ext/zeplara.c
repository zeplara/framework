...
zend_class_entry *zeplara_interfaces_file_finder_filter_ce;
zend_class_entry *zeplara_interfaces_routing_attribute_ce;
zend_class_entry *zeplara_interfaces_config_loader_ce;
zend_class_entry *zeplara_interfaces_repository_ce;
zend_class_entry *zeplara_interfaces_container_container_ce;
zend_class_entry *zeplara_interfaces_file_parser_parser_ce;
zend_class_entry *zeplara_interfaces_config_loaderexception_ce;
zend_class_entry *zeplara_interfaces_config_repository_ce;
zend_class_entry *zeplara_interfaces_container_bindingresolutionexception_ce;
zend_class_entry *zeplara_interfaces_container_invalidabstractexception_ce;
zend_class_entry *zeplara_interfaces_cookie_cookie_ce;
zend_class_entry *zeplara_interfaces_cookie_queue_ce;
zend_class_entry *zeplara_interfaces_encryption_encrypter_ce;
zend_class_entry *zeplara_interfaces_encryption_encryptionexception_ce;
zend_class_entry *zeplara_interfaces_file_finder_finder_ce;
zend_class_entry *zeplara_interfaces_file_finder_iterator_ce;
zend_class_entry *zeplara_interfaces_file_parser_compiledvalue_ce;
zend_class_entry *zeplara_interfaces_file_parser_linesiterator_ce;
zend_class_entry *zeplara_interfaces_file_parser_parserexception_ce;
zend_class_entry *zeplara_interfaces_file_parser_rawvalue_ce;
zend_class_entry *zeplara_interfaces_file_splfileinfo_ce;
zend_class_entry *zeplara_interfaces_pipeline_pipeline_ce;
zend_class_entry *zeplara_interfaces_routing_compiledroute_ce;
zend_class_entry *zeplara_interfaces_routing_group_ce;
zend_class_entry *zeplara_interfaces_routing_regex_ce;
zend_class_entry *zeplara_interfaces_routing_registrar_ce;
zend_class_entry *zeplara_interfaces_routing_route_ce;
zend_class_entry *zeplara_interfaces_routing_routecompiler_ce;
zend_class_entry *zeplara_interfaces_routing_routecompilerexception_ce;
zend_class_entry *zeplara_interfaces_routing_router_ce;
zend_class_entry *zeplara_interfaces_session_manager_ce;
zend_class_entry *zeplara_interfaces_application_ce;
zend_class_entry *zeplara_interfaces_session_flash_ce;
...
static PHP_MINIT_FUNCTION(zeplara)
{
	...
	zephir_module_init();
	ZEPHIR_INIT(Zeplara_Interfaces_File_Finder_Filter);
	ZEPHIR_INIT(Zeplara_Interfaces_Routing_Attribute);
	ZEPHIR_INIT(Zeplara_Interfaces_Config_Loader);
	ZEPHIR_INIT(Zeplara_Interfaces_Repository);
	ZEPHIR_INIT(Zeplara_Interfaces_Container_Container);
	ZEPHIR_INIT(Zeplara_Interfaces_File_Parser_Parser);
	ZEPHIR_INIT(Zeplara_Interfaces_Config_LoaderException);
	ZEPHIR_INIT(Zeplara_Interfaces_Config_Repository);
	ZEPHIR_INIT(Zeplara_Interfaces_Container_BindingResolutionException);
	ZEPHIR_INIT(Zeplara_Interfaces_Container_InvalidAbstractException);
	ZEPHIR_INIT(Zeplara_Interfaces_Cookie_Cookie);
	ZEPHIR_INIT(Zeplara_Interfaces_Cookie_Queue);
	ZEPHIR_INIT(Zeplara_Interfaces_Encryption_Encrypter);
	ZEPHIR_INIT(Zeplara_Interfaces_Encryption_EncryptionException);
	ZEPHIR_INIT(Zeplara_Interfaces_File_Finder_Finder);
	ZEPHIR_INIT(Zeplara_Interfaces_File_Finder_Iterator);
	ZEPHIR_INIT(Zeplara_Interfaces_File_Parser_CompiledValue);
	ZEPHIR_INIT(Zeplara_Interfaces_File_Parser_LinesIterator);
	ZEPHIR_INIT(Zeplara_Interfaces_File_Parser_ParserException);
	ZEPHIR_INIT(Zeplara_Interfaces_File_Parser_RawValue);
	ZEPHIR_INIT(Zeplara_Interfaces_File_SplFileInfo);
	ZEPHIR_INIT(Zeplara_Interfaces_Pipeline_Pipeline);
	ZEPHIR_INIT(Zeplara_Interfaces_Routing_CompiledRoute);
	ZEPHIR_INIT(Zeplara_Interfaces_Routing_Group);
	ZEPHIR_INIT(Zeplara_Interfaces_Routing_Regex);
	ZEPHIR_INIT(Zeplara_Interfaces_Routing_Registrar);
	ZEPHIR_INIT(Zeplara_Interfaces_Routing_Route);
	ZEPHIR_INIT(Zeplara_Interfaces_Routing_RouteCompiler);
	ZEPHIR_INIT(Zeplara_Interfaces_Routing_RouteCompilerException);
	ZEPHIR_INIT(Zeplara_Interfaces_Routing_Router);
	ZEPHIR_INIT(Zeplara_Interfaces_Session_Manager);
	ZEPHIR_INIT(Zeplara_Interfaces_Application);
	ZEPHIR_INIT(Zeplara_Interfaces_Session_Flash);
