...
PHP_METHOD(Zeplara_Http_ServerRequestFactory, create) {
	...
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zephir_fcall_cache_entry *_3 = NULL, *_4 = NULL, *_8 = NULL, *_11 = NULL;
	zval serverParams, parsedBody, queryParams, cookieParams, uploadedFiles, headers, _9$$10, _12$$11;
	zval *method_param = NULL, *uri = NULL, uri_sub, *body = NULL, body_sub, *serverParams_param = NULL, *parsedBody_param = NULL, *queryParams_param = NULL, *cookieParams_param = NULL, *uploadedFiles_param = NULL, *headers_param = NULL, *protocolVersion_param = NULL, _SERVER, _POST, _GET, _COOKIE, __$null, _0$$3, _2$$4, _5$$5, _6$$5, _7$$10, _10$$11;
	zval method, protocolVersion, _1$$3;
	zval *this_ptr = getThis();
	...
	if (1 == 0) {
		ZEPHIR_OBS_VAR(&_0$$3);
		zephir_array_fetch_string(&_0$$3, &_SERVER, SL("REQUEST_METHOD"), PH_NOISY, "zeplara/Http/ServerRequestFactory.zep", 42);
		zephir_get_strval(&_1$$3, &_0$$3);
		ZEPHIR_CPY_WRT(&method, &_1$$3);
	}
	if ((zephir_is_instance_of(uri, SL("Psr\\Http\\Message\\UriInterface"))) == 0) {
		ZEPHIR_CALL_CE_STATIC(&_2$$4, zeplara_http_urifactory_ce, "create", &_3, 0, uri);
		zephir_check_call_status();
		ZEPHIR_CPY_WRT(uri, &_2$$4);
	}
	if (Z_TYPE_P(body) == IS_NULL) {
		ZEPHIR_INIT_VAR(&_5$$5);
		ZVAL_STRING(&_5$$5, "php://input");
		ZEPHIR_INIT_VAR(&_6$$5);
		ZVAL_STRING(&_6$$5, "r+");
		ZEPHIR_CALL_CE_STATIC(body, zeplara_http_streamfactory_ce, "create", &_4, 0, &_5$$5, &_6$$5);
		zephir_check_call_status();
	}
	...
	if (ZEPHIR_IS_EMPTY(&uploadedFiles)) {
		ZEPHIR_CALL_SELF(&_7$$10, "parseuploadedfiles", &_8, 72);
		zephir_check_call_status();
		zephir_get_arrval(&_9$$10, &_7$$10);
		ZEPHIR_CPY_WRT(&uploadedFiles, &_9$$10);
	}
	if (ZEPHIR_IS_EMPTY(&headers)) {
		ZEPHIR_CALL_SELF(&_10$$11, "getallheaders", &_11, 73);
		zephir_check_call_status();
		zephir_get_arrval(&_12$$11, &_10$$11);
		ZEPHIR_CPY_WRT(&headers, &_12$$11);
	}
	object_init_ex(return_value, zeplara_http_serverrequest_ce);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 74, &method, uri, body, &serverParams, &parsedBody, &queryParams, &cookieParams, &uploadedFiles, &headers, &protocolVersion);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Zeplara_Http_ServerRequestFactory, parseUploadedFiles) {
	...
	array_init(&files);
	zephir_is_iterable(&_FILES, 0, "zeplara/Http/ServerRequestFactory.zep", 115);
	if (Z_TYPE_P(&_FILES) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_FILES), _2, _3, _0)
		{
			...
			zephir_array_fetch_string(&_4$$3, &value, SL("error"), PH_NOISY, "zeplara/Http/ServerRequestFactory.zep", 90);
			if (Z_TYPE_P(&_4$$3) == IS_ARRAY) {
				zephir_array_fetch_string(&_5$$4, &value, SL("error"), PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 92);
				zephir_is_iterable(&_5$$4, 0, "zeplara/Http/ServerRequestFactory.zep", 104);
				if (Z_TYPE_P(&_5$$4) == IS_ARRAY) {
					ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_5$$4), _8$$4, _9$$4, _6$$4)
					{
						...
						zephir_array_fetch_string(&_15$$5, &value, SL("tmp_name"), PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 97);
						zephir_array_fetch(&_16$$5, &_15$$5, &k$$4, PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 97);
						ZEPHIR_INIT_NVAR(&_17$$5);
						ZVAL_STRING(&_17$$5, "r");
						ZEPHIR_CALL_CE_STATIC(&_13$$5, zeplara_http_streamfactory_ce, "create", &_14, 0, &_16$$5, &_17$$5);
						zephir_check_call_status();
						zephir_array_fetch_string(&_18$$5, &value, SL("size"), PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 98);
						zephir_array_fetch(&_19$$5, &_18$$5, &k$$4, PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 98);
						zephir_array_fetch_string(&_20$$5, &value, SL("name"), PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 100);
						zephir_array_fetch(&_21$$5, &_20$$5, &k$$4, PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 100);
						zephir_array_fetch_string(&_22$$5, &value, SL("type"), PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 101);
						zephir_array_fetch(&_23$$5, &_22$$5, &k$$4, PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 102);
					...
					while (1) {
						...
						zephir_check_call_status();
							...
							zephir_array_fetch_string(&_27$$7, &value, SL("tmp_name"), PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 97);
							zephir_array_fetch(&_28$$7, &_27$$7, &k$$4, PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 97);
							ZEPHIR_INIT_NVAR(&_29$$7);
							ZVAL_STRING(&_29$$7, "r");
							ZEPHIR_CALL_CE_STATIC(&_26$$7, zeplara_http_streamfactory_ce, "create", &_14, 0, &_28$$7, &_29$$7);
							zephir_check_call_status();
							zephir_array_fetch_string(&_30$$7, &value, SL("size"), PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 98);
							zephir_array_fetch(&_31$$7, &_30$$7, &k$$4, PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 98);
							zephir_array_fetch_string(&_32$$7, &value, SL("name"), PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 100);
							zephir_array_fetch(&_33$$7, &_32$$7, &k$$4, PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 100);
							zephir_array_fetch_string(&_34$$7, &value, SL("type"), PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 101);
							zephir_array_fetch(&_35$$7, &_34$$7, &k$$4, PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 102);
				...
				zephir_array_fetch_string(&_38$$9, &value, SL("tmp_name"), PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 106);
				ZEPHIR_INIT_NVAR(&_39$$9);
				ZVAL_STRING(&_39$$9, "r");
				ZEPHIR_CALL_CE_STATIC(&_37$$9, zeplara_http_streamfactory_ce, "create", &_14, 0, &_38$$9, &_39$$9);
				zephir_check_call_status();
				zephir_array_fetch_string(&_40$$9, &value, SL("size"), PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 107);
				zephir_array_fetch_string(&_41$$9, &value, SL("error"), PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 108);
				zephir_array_fetch_string(&_42$$9, &value, SL("name"), PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 109);
				zephir_array_fetch_string(&_43$$9, &value, SL("type"), PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 111);
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_array_fetch_string(&_44$$10, &value, SL("error"), PH_NOISY, "zeplara/Http/ServerRequestFactory.zep", 90);
				if (Z_TYPE_P(&_44$$10) == IS_ARRAY) {
					zephir_array_fetch_string(&_45$$11, &value, SL("error"), PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 92);
					zephir_is_iterable(&_45$$11, 0, "zeplara/Http/ServerRequestFactory.zep", 104);
					if (Z_TYPE_P(&_45$$11) == IS_ARRAY) {
						ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_45$$11), _48$$11, _49$$11, _46$$11)
						{
							...
							zephir_array_fetch_string(&_53$$12, &value, SL("tmp_name"), PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 97);
							zephir_array_fetch(&_54$$12, &_53$$12, &k$$11, PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 97);
							...
							zephir_check_call_status();
							zephir_array_fetch_string(&_56$$12, &value, SL("size"), PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 98);
							zephir_array_fetch(&_57$$12, &_56$$12, &k$$11, PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 98);
							zephir_array_fetch_string(&_58$$12, &value, SL("name"), PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 100);
							zephir_array_fetch(&_59$$12, &_58$$12, &k$$11, PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 100);
							zephir_array_fetch_string(&_60$$12, &value, SL("type"), PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 101);
							zephir_array_fetch(&_61$$12, &_60$$12, &k$$11, PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 102);
						...
						while (1) {
							...
							zephir_check_call_status();
								...
								zephir_array_fetch_string(&_65$$14, &value, SL("tmp_name"), PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 97);
								zephir_array_fetch(&_66$$14, &_65$$14, &k$$11, PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 97);
								...
								zephir_check_call_status();
								zephir_array_fetch_string(&_68$$14, &value, SL("size"), PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 98);
								zephir_array_fetch(&_69$$14, &_68$$14, &k$$11, PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 98);
								zephir_array_fetch_string(&_70$$14, &value, SL("name"), PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 100);
								zephir_array_fetch(&_71$$14, &_70$$14, &k$$11, PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 100);
								zephir_array_fetch_string(&_72$$14, &value, SL("type"), PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 101);
								zephir_array_fetch(&_73$$14, &_72$$14, &k$$11, PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 102);
					...
					zephir_array_fetch_string(&_76$$16, &value, SL("tmp_name"), PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 106);
					...
					zephir_check_call_status();
					zephir_array_fetch_string(&_78$$16, &value, SL("size"), PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 107);
					zephir_array_fetch_string(&_79$$16, &value, SL("error"), PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 108);
					zephir_array_fetch_string(&_80$$16, &value, SL("name"), PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 109);
					zephir_array_fetch_string(&_81$$16, &value, SL("type"), PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 111);
...
PHP_METHOD(Zeplara_Http_ServerRequestFactory, getAllHeaders) {
	...
	if ((zephir_function_exists_ex(ZEND_STRL("getallheaders")) == SUCCESS)) {
		ZEPHIR_RETURN_CALL_FUNCTION("getallheaders", NULL, 75);
		zephir_check_call_status();
		RETURN_MM();
	}
	if ((zephir_function_exists_ex(ZEND_STRL("apache_request_headers")) == SUCCESS)) {
		ZEPHIR_RETURN_CALL_FUNCTION("apache_request_headers", NULL, 76);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_INIT_VAR(&headers);
	...
	zephir_is_iterable(&_SERVER, 0, "zeplara/Http/ServerRequestFactory.zep", 150);
	if (Z_TYPE_P(&_SERVER) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_SERVER), _2, _3, _0)
		{
			...
			if (ZEPHIR_IS_STRING(&_6$$5, "HTTP_")) {
				...
				zephir_array_fetch(&_10$$8, &copy_server, &key, PH_NOISY, "zeplara/Http/ServerRequestFactory.zep", 146);
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (ZEPHIR_IS_STRING(&_13$$9, "HTTP_")) {
					...
					zephir_array_fetch(&_17$$12, &copy_server, &key, PH_NOISY, "zeplara/Http/ServerRequestFactory.zep", 146);
	...
	if (!(zephir_array_isset_string(&headers, SL("Authorization")))) {
		if (zephir_array_isset_string(&_SERVER, SL("REDIRECT_HTTP_AUTHORIZATION"))) {
			zephir_array_fetch_string(&_18$$14, &_SERVER, SL("REDIRECT_HTTP_AUTHORIZATION"), PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 152);
			...
			zephir_array_fetch_string(&_19$$15, &_SERVER, SL("PHP_AUTH_USER"), PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 156);
			ZEPHIR_INIT_VAR(&_20$$15);
			ZEPHIR_CONCAT_VSV(&_20$$15, &_19$$15, ":", &basic_pass$$15);
			ZEPHIR_CALL_FUNCTION(&_21$$15, "base64_encode", NULL, 53, &_20$$15);
			zephir_check_call_status();
			...
			zephir_array_fetch_string(&_23$$16, &_SERVER, SL("PHP_AUTH_DIGEST"), PH_NOISY | PH_READONLY, "zeplara/Http/ServerRequestFactory.zep", 158);
