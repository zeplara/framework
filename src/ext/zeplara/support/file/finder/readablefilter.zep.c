...
ZEPHIR_INIT_CLASS(Zeplara_Support_File_Finder_ReadableFilter) {
	...
	ZEPHIR_REGISTER_CLASS_EX(Zeplara\\Support\\File\\Finder, ReadableFilter, zeplara, support_file_finder_readablefilter, zeplara_support_file_finder_abstractfilter_ce, zeplara_support_file_finder_readablefilter_method_entry, ZEND_ACC_FINAL_CLASS);
