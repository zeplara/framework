...
ZEPHIR_INIT_CLASS(Zeplara_Support_File_Finder_CallbackFilter) {
	...
	ZEPHIR_REGISTER_CLASS_EX(Zeplara\\Support\\File\\Finder, CallbackFilter, zeplara, support_file_finder_callbackfilter, zeplara_support_file_finder_abstractfilter_ce, zeplara_support_file_finder_callbackfilter_method_entry, ZEND_ACC_FINAL_CLASS);

	/**
	 * @var callable
	 */
	zend_declare_property_null(zeplara_support_file_finder_callbackfilter_ce, SL("callback"), ZEND_ACC_PRIVATE);
...
PHP_METHOD(Zeplara_Support_File_Finder_CallbackFilter, accept) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("call_user_func", NULL, 31, &_0, fileInfo);
