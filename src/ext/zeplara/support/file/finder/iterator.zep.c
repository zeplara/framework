...
PHP_METHOD(Zeplara_Support_File_Finder_Iterator, accept) {
	...
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "isaccepted", NULL, 173, &_0);
	zephir_check_call_status();
	RETURN_MM();
	...
	if (Z_TYPE_P(&_0) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _1)
		{
			...
			if (_5$$3) {
				...
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(NULL, &_6$$5, "__construct", &_12, 174, &_10$$5);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (_15$$7) {
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(NULL, &_16$$9, "__construct", &_12, 174, &_20$$9);
					zephir_check_call_status();
