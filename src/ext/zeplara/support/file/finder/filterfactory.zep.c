...
ZEPHIR_INIT_CLASS(Zeplara_Support_File_Finder_FilterFactory) {
	...
	ZEPHIR_REGISTER_CLASS(Zeplara\\Support\\File\\Finder, FilterFactory, zeplara, support_file_finder_filterfactory, zeplara_support_file_finder_filterfactory_method_entry, ZEND_ACC_FINAL_CLASS);
...
PHP_METHOD(Zeplara_Support_File_Finder_FilterFactory, file) {
	...
	object_init_ex(return_value, zeplara_support_file_finder_filefilter_ce);
...
PHP_METHOD(Zeplara_Support_File_Finder_FilterFactory, ignoreDotFile) {
	...
	object_init_ex(return_value, zeplara_support_file_finder_ignoredotfilefilter_ce);
	if (zephir_has_constructor(return_value)) {
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 0);
		zephir_check_call_status();
	}
...
PHP_METHOD(Zeplara_Support_File_Finder_FilterFactory, extension) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 169, &_0, state);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Zeplara_Support_File_Finder_FilterFactory, directory) {
	...
	object_init_ex(return_value, zeplara_support_file_finder_directoryfilter_ce);
	if (zephir_has_constructor(return_value)) {
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 0);
		zephir_check_call_status();
	}
...
PHP_METHOD(Zeplara_Support_File_Finder_FilterFactory, executable) {
	...
	object_init_ex(return_value, zeplara_support_file_finder_executablefilter_ce);
	if (zephir_has_constructor(return_value)) {
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 0);
		zephir_check_call_status();
	}
...
PHP_METHOD(Zeplara_Support_File_Finder_FilterFactory, link) {
	...
	object_init_ex(return_value, zeplara_support_file_finder_linkfilter_ce);
	if (zephir_has_constructor(return_value)) {
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 0);
		zephir_check_call_status();
	}
...
PHP_METHOD(Zeplara_Support_File_Finder_FilterFactory, readable) {
	...
	object_init_ex(return_value, zeplara_support_file_finder_readablefilter_ce);
	if (zephir_has_constructor(return_value)) {
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 0);
		zephir_check_call_status();
	}
...
PHP_METHOD(Zeplara_Support_File_Finder_FilterFactory, writable) {
	...
	object_init_ex(return_value, zeplara_support_file_finder_writablefilter_ce);
	if (zephir_has_constructor(return_value)) {
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 0);
		zephir_check_call_status();
	}
...
PHP_METHOD(Zeplara_Support_File_Finder_FilterFactory, callback) {
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 170, callback);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Zeplara_Support_File_Finder_FilterFactory, date) {
	...
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *time, time_sub, *operator = NULL, operator_sub, __$null;
	zval *this_ptr = getThis();
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 171, time, operator);
	zephir_check_call_status();
	RETURN_MM();
