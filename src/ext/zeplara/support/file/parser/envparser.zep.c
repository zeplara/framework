...
PHP_METHOD(Zeplara_Support_File_Parser_EnvParser, compileStringValue) {
	...
	if (zephir_is_true(&matches)) {
		...
		zephir_create_closure_ex(&_4$$3, NULL, zeplara_8__closure_ce, SL("__invoke"));
		...
		ZEPHIR_INIT_NVAR(&_6$$3);
		zephir_create_closure_ex(&_6$$3, NULL, zeplara_9__closure_ce, SL("__invoke"));
		zephir_update_static_property_ce(zeplara_9__closure_ce, ZEND_STRL("values"), values);
