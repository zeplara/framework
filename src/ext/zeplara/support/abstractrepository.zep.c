...
ZEPHIR_INIT_CLASS(Zeplara_Support_AbstractRepository) {
	...
	ZEPHIR_REGISTER_CLASS(Zeplara\\Support, AbstractRepository, zeplara, support_abstractrepository, zeplara_support_abstractrepository_method_entry, ZEND_ACC_EXPLICIT_ABSTRACT_CLASS);

	/**
	 * @var array
	 */
	zend_declare_property_null(zeplara_support_abstractrepository_ce, SL("items"), ZEND_ACC_PROTECTED);

	zeplara_support_abstractrepository_ce->create_object = zephir_init_properties_Zeplara_Support_AbstractRepository;
	return SUCCESS;
