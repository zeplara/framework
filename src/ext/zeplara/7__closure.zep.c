...
ZEPHIR_INIT_CLASS(zeplara_7__closure) {
	...
	zend_declare_property_null(zeplara_7__closure_ce, SL("line"), ZEND_ACC_PUBLIC|ZEND_ACC_STATIC);
...
PHP_METHOD(zeplara_7__closure, __invoke) {
	...
	ZEPHIR_MM_GROW();
	zephir_read_static_property_ce(&line, zeplara_7__closure_ce, SL("line"), PH_NOISY_CC);
