...
PHP_METHOD(Zeplara_Session_FileSessionHandler, __construct) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "is_writable", NULL, 169, path);
...
PHP_METHOD(Zeplara_Session_FileSessionHandler, destroy) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "is_file", NULL, 170, &file);
	zephir_check_call_status();
	if (zephir_is_true(&_1)) {
		...
		zephir_create_closure_ex(&_2$$3, NULL, zeplara_7__closure_ce, SL("__invoke"));
		ZEPHIR_CALL_FUNCTION(NULL, "set_error_handler", NULL, 49, &_2$$3);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(NULL, "unlink", NULL, 171, &file);
		zephir_check_call_status();
...
PHP_METHOD(Zeplara_Session_FileSessionHandler, gc) {
	...
	ZEPHIR_CALL_CE_STATIC(&_0, zeplara_file_finder_finder_ce, "instance", &_1, 0, &_2);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&_5);
	ZEPHIR_INIT_NVAR(&_5);
	zephir_create_closure_ex(&_5, NULL, zeplara_8__closure_ce, SL("__invoke"));
	ZEPHIR_CALL_FUNCTION(NULL, "set_error_handler", NULL, 49, &_5);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(&files) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&files), _7)
		{
			...
			zephir_check_call_status();
			ZEPHIR_CALL_FUNCTION(NULL, "unlink", &_10, 171, &_9$$3);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_check_call_status();
				ZEPHIR_CALL_FUNCTION(NULL, "unlink", &_10, 171, &_11$$4);
				zephir_check_call_status();
...
PHP_METHOD(Zeplara_Session_FileSessionHandler, write) {
	...
	ZVAL_LONG(&_2, 2);
	ZEPHIR_CALL_FUNCTION(&_3, "file_put_contents", NULL, 172, &_1, session_data, &_2);
	zephir_check_call_status();
