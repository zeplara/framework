...
PHP_METHOD(Zeplara_Session_FileSessionHandler, __construct) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "is_writable", NULL, 141, path);
...
PHP_METHOD(Zeplara_Session_FileSessionHandler, destroy) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "is_file", NULL, 142, &file);
	zephir_check_call_status();
	if (zephir_is_true(&_1)) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(NULL, "unlink", NULL, 143, &file);
		zephir_check_call_status();
...
PHP_METHOD(Zeplara_Session_FileSessionHandler, gc) {
	...
	if (Z_TYPE_P(&files) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&files), _7)
		{
			...
			zephir_check_call_status();
			ZEPHIR_CALL_FUNCTION(NULL, "unlink", &_10, 143, &_9$$3);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_check_call_status();
				ZEPHIR_CALL_FUNCTION(NULL, "unlink", &_10, 143, &_11$$4);
				zephir_check_call_status();
...
PHP_METHOD(Zeplara_Session_FileSessionHandler, write) {
	...
	ZVAL_LONG(&_2, 2);
	ZEPHIR_CALL_FUNCTION(&_3, "file_put_contents", NULL, 144, &_1, session_data, &_2);
	zephir_check_call_status();
